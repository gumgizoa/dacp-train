...
MCQA_INSTRUCTION_TEMPLATE="""Provide a detailed explanation to solve the question if possible. End your response with the correct option in the format "Answer: $OPTION".
Question: {query}
Options: 
{options}"""
